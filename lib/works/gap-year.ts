...
export const GAP_YEAR_LECTURES: GapYearLectureEntry[] = [
  {
    id: "data-literacy-ai",
    title: "데이터 리터러시와 AI",
    image: "/gap-year/lectures/data-literacy-ai.svg",
  ...
  },
  {
    ...
    title: "News 기사 분석 대시보드",
    image: "/gap-year/lectures/ssafy-news-dashboard.svg",
    imageAlt: "SSAFY 데이터 트랙 News 기사 분석 대시보드 특강",
    body: [
  ...
  },
  {
    id: "encore-ai-pm",
    title: "AI 프로젝트 관리",
    image: "/gap-year/lectures/encore-ai-pm.svg",
    imageAlt: "엔코아 AI 개발자 양성과정 AI 프로젝트 관리 특강",
    body: [
